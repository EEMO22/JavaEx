...
//		arrayCopySystem();
		...
		private static void arrayCopySystem() {
			...
			//	편리한 배열의 출력
//			System.out.println(source);	//	[I@7d6f77cc : 정수형 배열이 7d6f...에 있다
...
//			}
		...
		private static void defineArray() {
			...
			scores[2] = 85;
			scores[3] = 88;
//			scores[4] = 100;	//	ArrayIndexOutOfBoundException
			...
			//	배열은 참조 타입이다.
			int scores2[] = scores;	//	참조복사 : 객체를 복사한 것이 아니라, 주소만 복사!!
									//	같은 객체를 참조한다.
			
			System.out.println("scores: " + Arrays.toString(scores));
			System.out.println("scores2: " + Arrays.toString(scores2));
			
			scores2[2] = 100;	//	-> scores[2] == 100 주의!!
								//	같은 주소를 가리키므로
